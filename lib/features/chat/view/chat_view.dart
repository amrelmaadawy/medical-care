  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (_) => ConversationsCubit(ChatRepo())..fetchConversations(),
        ),
      ],
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: const TabBarView(
            children: [_ConversationsTab(), _DoctorsTab()],
          ),
        ),
      ),
    );
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (conv.lastMessage?.createdAt.isNotEmpty == true) {
                ...
                if (parts.length > 1) {
                  timeFormat = parts[1].substring(
                    0,
                    5,
                  ); // Assuming "2026-04-20 12:27:27" -> 12:27
                } else {
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                ...
                prefixIcon: Icon(Icons.search, color: kSubTextColor, size: 20),
            ...
            builder: (context, state) {
              if (state is DoctorsLoading) {
                ...
                if (filteredDoctors.isEmpty) {
                  return const Center(
                    child: Text('عفواً، لا يوجد طبيب يطابق بحثك'),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return DoctorItem(
                      name: doctor.name,
                      specialty: doctor.specialization.isNotEmpty
